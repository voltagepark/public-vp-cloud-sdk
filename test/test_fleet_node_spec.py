...
class TestFleetNodeSpec(unittest.TestCase):
    """FleetNodeSpec unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FleetNodeSpec:
        """Test FleetNodeSpec
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FleetNodeSpec`
        """
        model = FleetNodeSpec()
        if include_optional:
