...
class SlurmParametersSshKeysInner(BaseModel):
    """
    SlurmParametersSshKeysInner
    """ # noqa: E501
    name: Annotated[str, Field(min_length=1, strict=True, max_length=32)] = Field(description="Username for SSH access")
    keys: Annotated[List[Annotated[str, Field(strict=True)]], Field(min_length=1, max_length=10)] = Field(description="List of SSH public keys for this user")
    __properties: ClassVar[List[str]] = ["name", "keys"]
