...
class RemediateNodeRequest(BaseModel):
    ...
    message: Annotated[str, Field(strict=True, max_length=2000)] = Field(description="Description of the remediation reason")
    cause: StrictStr = Field(description="Cause for the remediation request")
    __properties: ClassVar[List[str]] = ["nodeId", "message", "cause"]
