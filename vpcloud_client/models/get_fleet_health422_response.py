...
class GetFleetHealth422Response(BaseModel):
    """
    GetFleetHealth422Response
    """ # noqa: E501
    error: StrictStr = Field(description="Error message describing why health cannot be retrieved")
    fleet_id: StrictStr = Field(description="Unique identifier for the fleet", alias="fleetId")
    status: StrictStr = Field(description="Current fleet status")
    __properties: ClassVar[List[str]] = ["error", "fleetId", "status"]
