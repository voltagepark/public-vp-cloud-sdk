...
class ExpandableNodeSpec(BaseModel):
    ...
    nodes: Optional[List[Node]] = Field(default=None, description="READ-ONLY: List of actual node details with IPs. This field is populated automatically during scaling operations and should not be provided in creation requests.")
