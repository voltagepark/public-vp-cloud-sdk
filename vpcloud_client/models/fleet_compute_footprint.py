...
class FleetComputeFootprint(BaseModel):
    """
    FleetComputeFootprint
    """ # noqa: E501
    gpu_nodes: FleetNodeSpec = Field(alias="gpuNodes")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "gpuNodes": FleetNodeSpec.from_dict(obj["gpuNodes"]) if obj.get("gpuNodes") is not None else None
        })
        return _obj
