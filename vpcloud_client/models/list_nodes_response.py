...
class ListNodesResponse(BaseModel):
    ...
    """ # noqa: E501
    nodes: List[Node] = Field(description="List of nodes in the fleet")
    next_token: Optional[StrictStr] = Field(default=None, description="Pagination token to retrieve the next page of results. Null when no more pages available.", alias="nextToken")
    ...
    __properties: ClassVar[List[str]] = ["nodes", "nextToken", "limit"]
