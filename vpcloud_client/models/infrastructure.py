...
class Infrastructure(BaseModel):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in vast (list)
        _items = []
        if self.vast:
            for _item_vast in self.vast:
                if _item_vast:
                    _items.append(_item_vast.to_dict())
            _dict['vast'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "vast": [StorageConfig.from_dict(_item) for _item in obj["vast"]] if obj.get("vast") is not None else None
        })
        return _obj
